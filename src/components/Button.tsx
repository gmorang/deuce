...
const variants: Record<Variant, string> = {
  primary: 'bg-accent text-accent-fg ring-1 ring-inset ring-white/15 shadow-[var(--shadow-accent)] hover:brightness-110',
  outline: 'border border-border-strong text-fg hover:bg-surface-2',
  ghost: 'text-fg-muted hover:bg-surface-2 hover:text-fg',
  danger: 'bg-danger text-danger-fg hover:brightness-[1.08]',
}
